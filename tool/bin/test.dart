...
final _errorLinePattern = RegExp(r"// \[((loxlox) )?line (\d+)\] (Error.*)");
...
void _defineTestSuites() {
  void lox(String name, Map<String, String> tests) {
    var executable = name == "loxlox" ? "build/loxloxd" : "build/$name";
    _allSuites[name] = Suite(name, "lox", executable, [], tests);
    _loxSuites.add(name);
  }
  ...
  // No control flow in Lox yet.
  var noLoxControlFlow = {
  ...
  // No inheritance in Lox yet.
  var noLoxInheritance = {
  ...
  lox("chap29_superclasses", {
    "test": "pass",
    ...earlyChapters,
  });

  lox("chap30_optimization", {
    "test": "pass",
    ...earlyChapters,
  });
}
